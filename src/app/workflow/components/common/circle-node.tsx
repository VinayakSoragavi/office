...
function CircleNode({data,getHandleType,handleStyle,selected}:{
    data:CustomNodeData,
  ...
  return (
    <div className={`flex flex-col items-center relative ${selected?"pb-[0.1px]":"pb-0"}`}>
      <div>
      <div className={`px-4 py-2 shadow-md w-20 h-10 rounded-2xl bg-[#ffffff] border-2 ${selected?"border-[#343439]":"border-[#344767]"}`}>
        <Handle
