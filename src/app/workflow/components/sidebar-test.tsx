...
const SidebarTest = ({ onAddNode }: SidebarProps) => {

  return (
    <motion.div
      className="w-64 h-full bg-gradient-to-b from-[#3f3f46] to-[#1b1b1b] backdrop-blur-lg shadow-lg text-white flex flex-col rounded-xl pb-6"
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto">
        <div className="p-4">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-1 pl-3">
              <div className="flex items-center gap-3 px-3 py-2 active-item rounded-lg">
                <span className="w-6 h-6 flex items-center justify-center bg-white text-[#1a73e8] rounded-lg font-medium">
                  A
                </span>
          ...
          {/* Pages Section */}
          <div className="mb-2">
            <span className="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Work Flow</span>
          </div>

          {/* Pages Menu Items */}
          <PagesDropdown  onAddNode={onAddNode}/>
