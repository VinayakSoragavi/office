...
import { Plus, MousePointer, Square, Circle, ArrowUpRight, Pencil, Link, Type, Maximize } from "lucide-react"
import ToolButton from "./common/button/ToolButton"
import { ShapeType } from "@/types/shapes"

interface ToolbarProps {
  selectedTool: "select" | ShapeType
  setSelectedTool: (tool: "select" | ShapeType) => void
}
